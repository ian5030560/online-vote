...
export function ThemeButton({ mode }: { mode: Mode }): [HTMLDivElement, (mode: Mode) => void] {
    ...
    let sunIcon = createNS("http://www.w3.org/2000/svg", "svg",
        {
    ...
    let sunPath = createNS("http://www.w3.org/2000/svg", "path", {
    ...
    let moonIcon = createNS("http://www.w3.org/2000/svg", "svg", {
        className: "bi bi-moon-fill",
        id: "theme-icon",
        attributes: { width: "16", height: "16", fill: "currentColor", viewBox: "0 0 16 16" }
    });
    let moonPath = createNS("http://www.w3.org/2000/svg", "path", {
    ...
    function setMode(mode: Mode) {
        ...
        add(button, mode === "light" ? add(sunIcon, sunPath) : add(moonIcon, moonPath));
    ...
    return [add(button, mode === "light" ? add(sunIcon, sunPath) : add(moonIcon, moonPath)), setMode];
}